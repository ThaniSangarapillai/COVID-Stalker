...
// 43.662896, -79.395437
// radius 50 - 500
var calculate = (user_lat, user_lon): void => {
    var count = 0;
    for (let i = 0; i < locationList.length; i++) {
        var dist_to_point = haversine(user_lat, locationList[i].latitude, user_lon, locationList[i].longitude);
